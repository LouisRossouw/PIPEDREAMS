...
# import toolUtils.setShot_utils as ssUtils
...
icon_1 = "D:/work/projects/dev/projects/PIPEDREAMS/pipedreams/pipeline/resources/windows_tray_icons/tray_icon_animations/default_colors/px_1.png"
maya_icon = "D:/work/projects/dev/projects/PIPEDREAMS/pipedreams/pipeline/resources/UI/maya_20.png"
houdini_icon = "D:/work/projects/dev/projects/PIPEDREAMS/pipedreams/pipeline/resources/UI/houdini_20.png"
...
def PipeDreams_UI(config):
    ...
    Pipedreams_TAB_01 = [
                            ...
                            # [sg.Text("Task")],
                            # [sg.Text("Priority"), sg.InputCombo(("Low", "Medium", "High"), enable_events=True, key="-PRIORITY_SEL-")],
                            # [sg.Listbox(values=get_tasks(), size =(20, 12), enable_events=True, key='-TASK_LIST-'),

							# sg.Output(s=(15,2), key="-OUTPUT-")],
                            ...
                            sg.Button("", enable_events=True, image_filename=maya_icon, size=(1,10), tooltip="Launch Maya", key="Maya"), sg.Button("", enable_events=True, image_filename=houdini_icon, size=(1,10),tooltip="Launch Houdini")],
    ...
    tab_group_layout = [
                            ...
                            sg.Tab('Utils', Utils_TAB_02, visible=False, key='-TAB3-'),]
                        ]
    ...
    layout = [
				...
				[sg.Multiline(size=(5,2), font='Courier 8', expand_x=True, expand_y=True, write_only=False,
							reroute_stdout=True, reroute_stderr=True, echo_stdout_stderr=True, autoscroll=True, auto_refresh=True, background_color="black")],
