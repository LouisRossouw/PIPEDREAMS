...
def run():
    ...
    # Open config
    path_to_main = os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__)))))))
    # config_path = os.path.abspath(__file__)
    config = yaml.safe_load(open(f'{path_to_main}\\admin\\pipeline_config.yaml', 'r'))
