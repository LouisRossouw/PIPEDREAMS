...
- the default mgear controls naming convention.
- currently only works with NO name spaces and include _rig in its top group name.
- currently only works with T-pose arms.
- currently only works with default human scale - 172cm etc.
- currently crashes when saving poses.
