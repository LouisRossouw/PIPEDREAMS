...
def getUserDataBase():
    ...
    user_data_base = f"{os.path.dirname(os.path.dirname(os.path.dirname(getPipelineRoot())))}/admin/data/user_data_base/user_data_base.json"
...
def getEnvPath():
    ...
    extra_env_path = os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(__file__))))
    extra_env_text = f"{extra_env_path}/DCC/maya/extra_env.txt"
