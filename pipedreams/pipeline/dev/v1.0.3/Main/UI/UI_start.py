...
def PipeDreams_UI(config):
    ...
    Pipedreams_TAB_01 = [
                            ...
                            [sg.Listbox(values=get_all_projects_list(main_projects_path), size=(20, 12), key='-LIST-', enable_events=True)]
    ...
    layout = [
				...
				[sg.Multiline(size=(50,5), font='Courier 8', expand_x=True, expand_y=True, write_only=False,
