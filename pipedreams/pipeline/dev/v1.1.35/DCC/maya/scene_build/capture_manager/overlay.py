...
def test():
    ...
    tt = os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(__file__))))))))
    print(tt)
...
def add_overlay(original_file,
    ...
    # Open config
    pipedreams_dir = os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(__file__))))))))
    path_to_config = pipedreams_dir + '/admin/DCC_configs'

    # Open config
    config = yaml.safe_load(open(f'{path_to_config}\\maya_config.yaml', 'r'))
    ...
    if create_overlay == True:
        ...
        comment_reformatted = '"' + '| '+project_name + ' || ' + comment + '"'
