...
def run():
    ...
    if privilages == "Tivoli":
        ...
        cmd_line_start_path = f"{production_path}/{pipeline_version}/Main/cmd_line/cmd_line_start.py"
...
def checkUser_list(pipeline_version, cmd_line_start_path, privilages, title, pipeline_version_path):
    ...
    user_data_base = f"{os.path.dirname(os.path.dirname(__file__))}/admin/data/user_data_base/user_data_base.json"
